...
{#if name === 'clipboard-document-list'}
	<svg
		xmlns="http://www.w3.org/2000/svg"
		fill="none"
		viewBox="0 0 24 24"
...
{#if name === 'trash'}
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="hover:text-error-500 h-4 w-4"
		><path
			fill="currentColor"
