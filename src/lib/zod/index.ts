...
export const BankAccountScalarFieldEnumSchema = z.enum(['id','userId','createdAt','updatedAt','accountHolder','accountNo','accountType','bankName','branchCode']);
...
export const VerificationTokenScalarFieldEnumSchema = z.enum(['id','type','expires','token','userId']);

export const IntegrationScalarFieldEnumSchema = z.enum(['id','createdAt','updatedAt','userId']);

export const PayfastScalarFieldEnumSchema = z.enum(['id','integrationId','merchantId','merchantKey','passphrase','createdAt','updatedAt','active']);

export const YocoScalarFieldEnumSchema = z.enum(['id','integrationId','publicKey','secretKey','webhookSecret','createdAt','updatedAt','active']);
...
export type LastUsedSerialWithRelations = z.infer<typeof LastUsedSerialSchema> & LastUsedSerialRelations

export const LastUsedSerialWithRelationsSchema: z.ZodType<LastUsedSerialWithRelations> = LastUsedSerialSchema.merge(z.object({
...
export const BankAccountWithRelationsSchema: z.ZodType<BankAccountWithRelations> = BankAccountSchema.merge(z.object({
  user: z.lazy(() => UserWithRelationsSchema),
}))
...
export const OauthAccountWithRelationsSchema: z.ZodType<OauthAccountWithRelations> = OauthAccountSchema.merge(z.object({
  user: z.lazy(() => UserWithRelationsSchema),
}))
...
export const PasswordWithRelationsSchema: z.ZodType<PasswordWithRelations> = PasswordSchema.merge(z.object({
  user: z.lazy(() => UserWithRelationsSchema),
}))
...
export type VerificationTokenWithRelations = z.infer<typeof VerificationTokenSchema> & VerificationTokenRelations

export const VerificationTokenWithRelationsSchema: z.ZodType<VerificationTokenWithRelations> = VerificationTokenSchema.merge(z.object({
  user: z.lazy(() => UserWithRelationsSchema),
}))
...
export const IntegrationWithRelationsSchema: z.ZodType<IntegrationWithRelations> = IntegrationSchema.merge(z.object({
  user: z.lazy(() => UserWithRelationsSchema),
...
export const PayfastWithRelationsSchema: z.ZodType<PayfastWithRelations> = PayfastSchema.merge(z.object({
...
export const YocoWithRelationsSchema: z.ZodType<YocoWithRelations> = YocoSchema.merge(z.object({
  integration: z.lazy(() => IntegrationWithRelationsSchema),
}))
...
export const QuickLinkWithRelationsSchema: z.ZodType<QuickLinkWithRelations> = QuickLinkSchema.merge(z.object({
  user: z.lazy(() => UserWithRelationsSchema),
...
export type InvoiceRelations = {
  ...
  sendersAddress: AddressWithRelations;
  client: ClientWithRelations;
  invoiceStyle?: InvoiceStylesWithRelations | null;
};
...
export const InvoiceWithRelationsSchema: z.ZodType<InvoiceWithRelations> = InvoiceSchema.merge(z.object({
  ...
  invoiceStyle: z.lazy(() => InvoiceStylesWithRelationsSchema).nullable(),
}))
...
export type InvoiceStylesWithRelations = z.infer<typeof InvoiceStylesSchema> & InvoiceStylesRelations

export const InvoiceStylesWithRelationsSchema: z.ZodType<InvoiceStylesWithRelations> = InvoiceStylesSchema.merge(z.object({
  user: z.lazy(() => UserWithRelationsSchema),
  Invoice: z.lazy(() => InvoiceWithRelationsSchema).array(),
}))
