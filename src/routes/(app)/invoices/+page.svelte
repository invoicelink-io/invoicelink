...
<div class="grid w-full gap-4 sm:grid-cols-3">
	<a class="card-primary gap-2 p-4" href="/invoices/management">
		<h6 class="h6 w-full text-center sm:text-left">Invoices</h6>
	...
	<a class="card-primary gap-2 p-4" href="/invoices/template">
		<h6 class="h6 w-full text-center sm:text-left">Templates</h6>
		<p class="w-full text-center text-sm font-light sm:text-left">
