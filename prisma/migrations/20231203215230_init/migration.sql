-- CreateEnum
CREATE TYPE "SerialType" AS ENUM ('QUICK_LINK', 'INVOICE');
...
-- CreateTable
CREATE TABLE "LastUsedSerial" (
    "id" TEXT NOT NULL,
    "serial" TEXT NOT NULL,
    "type" "SerialType" NOT NULL,
    "userId" TEXT NOT NULL,

    CONSTRAINT "LastUsedSerial_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "LastUsedSerial_id_key" ON "LastUsedSerial"("id");

-- CreateIndex
CREATE UNIQUE INDEX "LastUsedSerial_userId_type_key" ON "LastUsedSerial"("userId", "type");
...
-- AddForeignKey
ALTER TABLE "LastUsedSerial" ADD CONSTRAINT "LastUsedSerial_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
